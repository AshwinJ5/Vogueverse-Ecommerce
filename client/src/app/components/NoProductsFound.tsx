        ...
        <div className="font-display bg-background-light text-text-light flex flex-col w-full overflow-x-hidden">
            ...
            <main className="flex flex-1 items-center justify-center py-16 px-4">
                <div className="flex flex-col items-center gap-6 max-w-lg w-full text-center">
                    {/* Illustration */}
                    <div className="w-48 h-48 flex items-center justify-center text-secondary animate-in fade-in zoom-in duration-500">
                        <svg
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h1 className="text-3xl font-black leading-tight tracking-tight text-text-light">
                            Oops! Nothing Matches Your Search
                        </h1>
                        <p className="text-secondary-text-light text-lg font-normal max-w-sm">
                            {
                                "We couldn't find any products that match your current filters. Try removing a filter or searching for a different keyword."
                            }
                        </p>
                    </div>

                    {/* Action Button */}
                    <Link href="/catagory" className="w-full sm:w-auto">
                    ...
                    {/* Helper Link */}
                    <p className="text-secondary-text-light text-sm font-normal pt-2">
                        Or,{" "}
                        <Link
                            href="/catagory"
