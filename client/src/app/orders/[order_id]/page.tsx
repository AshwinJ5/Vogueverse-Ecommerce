    ...
    <div className="font-display bg-background-light text-text-light min-h-screen flex flex-col w-full overflow-x-hidden">
      ...
      <main className="container mx-auto px-4 sm:px-6 py-8">
        ...
        {/* <div className="flex flex-wrap gap-2 mb-6">
          <Link className="text-sm font-medium text-gray-500 hover:text-primary" href="/">Home</Link>
          <span className="text-sm text-gray-400">/</span>
          <Link className="text-sm font-medium text-gray-500 hover:text-primary" href="#">My Account</Link>
          <span className="text-sm text-gray-400">/</span>
          <Link className="text-sm font-medium text-gray-500 hover:text-primary" href="/orders">Orders</Link>
          <span className="text-sm text-gray-400">/</span>
          <span className="text-sm font-medium text-text-light">#ORD12345678</span>
        </div> */}

        {/* Page Heading */}
        <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
          <div className="flex flex-col gap-2">
            <h1 className="text-text-light text-3xl md:text-4xl font-extrabold leading-tight tracking-tight">Order Details</h1>
            <p className="text-gray-500">Order <span className="font-semibold text-text-light">#ORD12345678</span> placed on <span className="font-semibold text-text-light">August 15, 2024</span></p>
          </div>
          <div className="flex items-center gap-3">
            <button className="flex items-center justify-center gap-2 rounded-lg h-11 px-5 text-sm font-semibold bg-primary/10 text-primary hover:bg-primary/20 transition-colors">
              <span className="material-symbols-outlined text-lg">download</span>
              Download Invoice
            </button>
            <button className="flex items-center justify-center gap-2 rounded-lg h-11 px-5 text-sm font-semibold bg-primary text-white hover:bg-opacity-90 transition-colors">
              Return Items
            </button>
          </div>
        </div>
                ...
                <div className="flex items-start gap-4 z-10">
                  ...
                  <div>
                    ...
                    <div className="mt-2 text-sm">
                      <p className="text-gray-600">Tracking: <a className="text-primary font-medium hover:underline" href="#">1Z999AA10123456784</a></p>
                    </div>
                  </div>
                </div>
